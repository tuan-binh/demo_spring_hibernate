package ra.spring_hibernate_orm.configs;
...
@Configuration
@EnableTransactionManagement // hỗ trợ quản lí transaction
public class HibernateConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3307/orm?createDatabaseIfNotExist=true");// replace with your database URL
